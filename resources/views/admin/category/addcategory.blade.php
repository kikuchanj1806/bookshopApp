...
@section('content')
 ...
 'level2' => 'Thêm danh mục',
 'route1' => '/admin/category/index',
 'route2' => '/admin/category/add'
 ])
    <div class="row">
        <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="order" placeholder="Thứ tự">
                                    @error('order')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex mt-0">
                                        ...
                                        <input type="hidden" name="icon" id="icon_thumb" value="">
                                        <div class="me-3 imageArea2"><i class="fal fa-camera-alt fa-2x"></i></div>
                                        <div class="media-body">
                                            <div class="uniform-uploader" id="uniform-imageUpload">
                                            ...
                                            <div class="error"></div>
                                            <span
                                                    class="form-text text-muted">File: gif, png, jpg, bmp (Tối đa 4MB)</span>
                                        </div>
                                    </div>
                                </div>
