                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                        ...
                                        <div id="image_show">
                                            @if($cate->image)
                                                <a href="{{$cate->image}}" target="_blank">
                                                    <img src="{{$cate->image}}" alt="{{$cate->name}}" width="60px"
                                                         class="me-3"/>
                                                </a>
                                            @endif
                                        </div>
                                        <input type="hidden" name="image" id="thumb" value="{{ $cate->image ?? '' }}">
                                        <div class="me-3 imageArea1 {{ $cate->image ? 'd-none' : '' }}"><i
                                        ...
                                        <div id="icon_show">
                                            @if($cate->icon)
                                                <a href="{{$cate->icon}}" target="_blank">
                                                    <img src="{{$cate->icon}}" alt="{{$cate->name}}" width="60px"
                                                         class="me-3"/>
                                                </a>
                                            @endif
                                        </div>
                                        <input type="hidden" name="icon" id="icon_thumb"
                                               value="{{ $cate->icon ?? '' }}">
                                        <div class="me-3 imageArea2 {{ $cate->icon ? 'd-none' : '' }} "><i
                                                    class="fal fa-camera-alt fa-2x"></i></div>
                                        <div class="media-body">
                                            <div class="uniform-uploader" id="uniform-imageUpload">
                                                <input type="file" class="form-input-styled businessFileUpload"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select" name="status_display_index"
                                            id="exampleFormControlSelect2">
                                        <option value="0" {{ $cate->status_display_index == 0 ? 'selected' : '' }}>Ẩn
                                        </option>
                                        <option value="1" {{ $cate->status_display_index == 1 ? 'selected' : '' }}>Hiển
                                            thị
                                        </option>
                                    </select>
