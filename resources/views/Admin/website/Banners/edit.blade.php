...
@section('content')
    ...
    'route2' => '/admin/website/banners/edit/' . $banner->id,
    ])
    <div class="row">
        <div class="col-12">
                                        ...
                                        <div id="image_show">
                                            @if($banner->image)
                                                <a href="{{$banner->image}}" target="_blank">
                                                    <img src="{{$banner->image}}" alt="{{$banner->title}}" width="60px" class="me-3"/>
                                                </a>
                                            @endif
                                        </div>
                                        <input type="hidden" name="image" id="thumbBanner" value="{{ $banner->image ?? '' }}">
                                        <div class="me-3 imageArea3 {{ $banner->image ? 'd-none' : '' }}"><i class="fal fa-camera-alt fa-2x"></i></div>
